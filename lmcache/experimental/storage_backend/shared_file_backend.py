...
from lmcache.experimental.protocol import SharedFileMetadata
...
class SharedFileBackend(StorageBackendInterface):
    ...
    def contains(self, key: CacheEngineKey) -> bool:
        ...
        """
        return self.bitcask_reader.containers(key.to_string())
    ...
    async def async_save_bytes(self, key: CacheEngineKey, obj: MemoryObj):
        ...
        async with aiohttp.ClientSession() as session:
            ...
            reader.feed_eof()
            async with session.post(url, data=reader) as response:
